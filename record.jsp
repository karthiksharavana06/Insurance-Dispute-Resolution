...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="record.jsp">Police Report</a></li>
                            <li class="nav-item"><a class="nav-link" href="record1.jsp">Doctor Report</a></li>
                            <li class="nav-item "><a class="nav-link" href="insu_approval.jsp">Approval</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
            <center>
              <font face="Algerian" color="blue" size="6px"><center><b>DOWNLOAD PATIENT POLICE REPORT</b></center></font>
        ...
        <tr>
            ...
            <td align="center"><font face="Algerian" color="black" size="5px"><b>INSURANCE POLICY ID</b></font></td>
            <td align="center"><font face="Algerian" color="black" size="5px"><b>POLICE RECORDS</b></font></td>
             <td align="center"><font face="Algerian" color="black" size="5px"><b>ACCIDENT IMAGE1</b></font></td>
              <td align="center"><font face="Algerian" color="black" size="5px"><b>ACCIDENT IMAGE2</b></font></td>
          </tr> 
<section class="wrapper">
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql = "select insurance_claim.sno,insurance_claim.username,insurance_claim.policy,road_location.sno,road_location.pic,road_location.image from insurance_claim left join road_location on insurance_claim.sno=road_location.sno";
      ...
      %>  
     <tr> 
             <td align="center"><font face="georgia" color="black" size="4px"><b><%=resultSet1.getString("sno")%> </td>
            <td align="center"><font face="georgia" color="black" size="4px"><b><%=resultSet1.getString("username")%></td>
           <td align="center"><font face="georgia" color="black" size="4px"><b><%=resultSet1.getString("policy")%></b></a>
           <td align="center"><a href="download1?sno=<%=resultSet1.getString("sno")%>"><b>DOWNLOAD</b></a></td>
           <td><img src="image1.jsp?id=<%=resultSet1.getString("sno")%>" style="width: 200px;height: 150px"></td>
           <td><img src="image1.jsp?id=<%=resultSet1.getString("sno")%>" style="width: 200px;height: 150px"></td>
