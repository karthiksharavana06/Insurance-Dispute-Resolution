...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item "><a class="nav-link" href="user.jsp">Other</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <section class="wthree-row py-md-5" id="about">
        <form method="post" action="insurance_login">
            <center>
            <font face="Algerian" color="blue" size="6px"><center><b> INSURANCE LOGIN</b></center></font>
                <br> <p><font face="Algerian" color="black" size="5px"><b>INSURANCE ID &nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="uid" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
            ...
            <br><input type="submit" value="LOGIN" style="width: 15% ; height:45px ;font-family: georgia; font-size: 19px; font-weight: bold; background-color: skyblue; border-color: blue">
           <br> <br><font face="Algerian" size="5px"><b>Are you a New User ??? Please </b><a href="insurance_registration.jsp"> <b>Sign Up</b> </a> <b>then...</b>
        </center>
        </form>
    </section>
