                ...
                <div class="nav_w3ls">
                    <nav>
                       ...
                       <ul class="menu">
                            ...
                            <li class="nav-item "><a class="nav-link" href="viewreport.jsp">View Report</a></li>
                            <li class="nav-item "><a class="nav-link" href="insurance_claim.jsp">Insurance Claim</a></li>
           ...
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql = "select a.*,b.status from road_location1 as a left join doc_request1 as b on a.sno=b.acc_id and b.user_name='"+session.getAttribute("username")+"' where loc='"+location+"'";
      ...
      %>  
            <tr>                    
                                    ...
                                    if(sts!=null)
                                    {
                                        ...
                                        {
                                            %>
                                            <a href="Download12?id=<%=resultSet1.getString("sno")%>">download</a>
                                    ...
                                    {
                                        %>
                                        <a href="sendRequest1.jsp?id=<%=resultSet1.getString("sno")%>&docname=<%=resultSet1.getString("docfilename")%>&loc=<%=resultSet1.getString("loc")%>">Send Request</a>
                                        <%
                                    }
                                    %></td>
