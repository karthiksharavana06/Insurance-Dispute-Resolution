...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="view_accident.jsp"> POLICE REPORT</a></li>
                            <li class="nav-item "><a class="nav-link" href="view_report.jsp"> DOCTOR REPORT</a></li>
                            <li class="nav-item "><a class="nav-link" href="report.jsp">REQUEST REPORT</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
        <font face="Algerian" color="blue" size="6px"><center><b> ACCIDENT REPORT</b></center></font>
           ...
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql = "select * from accident_info where p_name='"+session.getAttribute("username")+"'";
      ...
      %>  
           <tr><tr><td align="center"><font face="Algerian" color="black" size="5px"><b>S.NO</b></font></td><td align="center"><font face="georgia" color="#0C6E69" size="5px"><b><%=resultSet1.getString("sno")%> </td></tr>
            ...
            <tr> <td align="center"><font face="Algerian" color="black" size="5px"><b>SPEED OTHER VEHICLE WAS TRAVELLING?? </b></font></td><td align="center"><font face="georgia" color="#0C6E69" size="5px"><b><%=resultSet1.getString("speed")%>&nbsp;Km/Hr</td></tr>
             <table><br><br><tr align="bottom"> <a href="sendtoinsurance.jsp?patient_name=<%=resultSet1.getString("p_name")%>"><center><button style="width: 30%; height: 50px; bottom:  45px; font-family: georgia; font-size: 20px; font-weight: bold">SEND TO INSURANCE</button></center></a></tr>
</table>
            <%
