...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="insurance.jsp">Insurance</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
        <form method="post" action="insurance_registration">
            <center>
            <font face="Algerian" color="blue" size="6px"><center><b> INSURANCE REGISTRATION</b></center></font>
                <br> <p><font face="Algerian" color="black" size="5px"><b>INSURANCE ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b></font>&nbsp;&nbsp;<input type="text" name="id" value="<%=id%>" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
                <br> <p><font face="Algerian" color="black" size="5px"><b>COMPANY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b></font>&nbsp;&nbsp;<input type="text" name="firstname" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
                <br> <p><font face="Algerian" color="black" size="5px"><b>DESIGNATION&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="lastname" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
                ...
                <br> <br><font face="Algerian" size="5px"><b>Already Registered ??? Please </b><a href="insurance.jsp"> <b>Login</b> </a> <b>then...</b>
           </center>
           </form>
          </section>
