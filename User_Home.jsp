...
<body>
    ...
    <section class="wthree-row py-md-5" id="about">
      ...
      <tr style="background-color: rgb(15, 109, 117);color: white">
          <td style="font-weight: bold"><center>Serial No</center></td>
          <td style="font-weight: bold"><center>Place</center></td>
         
         <td style="font-weight: bold"><center>Year</center></td>
         <td style="font-weight: bold"><center>Mode of accident</center></td>
         <td style="font-weight: bold"><center>Cause  of accident</center></td>
         <td style="font-weight: bold"><center>No of accident</center></td>
           ...
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql1 = "select * from data_cluster";
      ...
      %>  
            <tr>                    
                ...
                <td><center><%=resultSet1.getString("sno")%></center></td>
                                    
                                    <td><center><%=resultSet1.getString("place")%></center></td>
                                    <td><center><%=resultSet1.getString("year")%></center></td>
                                    <td><center><%=resultSet1.getString("mode")%></center></td>
                                    <td><center><%=resultSet1.getString("cause")%></center></td>
                                    <td><center><%=resultSet1.getString("accident")%></center</td> 
