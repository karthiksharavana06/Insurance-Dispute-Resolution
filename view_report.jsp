...
<body>
    ...
    <section class="wthree-row py-md-5" id="about">
       <font face="Algerian" color="blue" size="6px"><center><b>REQUESTED MEDICAL REPORT</b></center></font>
           ...
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql = "select * from medical_report where p_name='"+session.getAttribute("username")+"'";
