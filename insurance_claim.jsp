...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                       ...
                       <ul class="menu">
                            ...
                            <li class="nav-item  "><a class="nav-link" href="search.jsp">Police</a></li>
                            ...
                            <li class="nav-item active"><a class="nav-link" href="insurance_claim.jsp">Police Report</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
        <%
                    ...
                    String sql = "select * from insurance_register ";                    statement = connection.createStatement();
      ...
      %>  
      <form action="insurance_claim" method="post" enctype="multipart/form-data"><center>
                            <font face="Algerian" color="blue" size="8px"><center><b> INSURANCE CLAIM</b></center></font>
                            <font face="Algerian" color="blue" size="6px"><center><b>POLICE UPDATE</b></center></font>
                            <br>
            <br> <p><font face="Algerian" color="black" size="5px"><b>USERNAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="username" value="<%=session.getAttribute("username")%>" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/></p>
             <br><br> <p><font face="Algerian" color="black" size="5px"><b>INSURANCE NAME &nbsp;:</b></font>&nbsp;&nbsp;
              <select name="insurance"  style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/>
                  <%
             while(resultSet1.next())
                   {
                   
            %> 
             <option value="<%=resultSet1.getString("username")%>"><%=resultSet1.getString("username")%></option>            <%
                   }
            %>
            </select></p>

            <br><br> <p><font face="Algerian" color="black" size="5px"><b> POLICY-ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="policy" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" /></p>
            <br> <br> <p><font face="Algerian" color="black" size="5px"><b>REPORTS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="file" name="reports" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/></p>
            <br><br><input type="submit" value="SUBMIT" style="width: 15% ; height:45px ;font-family: georgia; font-size: 19px; font-weight: bold; background-color: skyblue; border-color: blue">
