...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                       ...
                       <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="request2.jsp">Doctor</a></li>
    ...
    <section class="wthree-row py-md-5" id="about"> 
        ...
        <form method="post" action="view_report" >  
           ...
           <br> <p><font face="Algerian" color="black" size="5px"><b>AADHAR ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="hospital" value="" maxlength="12"style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/></p>
           <br> <p><font face="Algerian" color="black" size="5px"><b>DOCTOR NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="reports" value="" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/></p>
           <br> <p><font face="Algerian" color="black" size="5px"><b>HOSPITAL NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="location" value="" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" /></p>
           <br> <p><font face="Algerian" color="black" size="5px"><b>USER NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="patient_name" value="" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue"/></p>
...
<br><input type="submit" value="REQUEST" style="width: 15% ; height:45px ;font-family: georgia; font-size: 19px; font-weight: bold; background-color: skyblue; border-color: blue">
       <a href="request3.jsp"><input type="submit" value="NEXT" style="width: 15% ; height:45px ;font-family: georgia; font-size: 19px; font-weight: bold; background-color: skyblue; border-color: blue"></a>
