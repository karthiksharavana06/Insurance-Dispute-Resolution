 ...
 * @author trios
 */
@WebServlet(urlPatterns = {"/nomiee_login"})

public class nominee_login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DbConnection db1=new DbConnection();
           ...
           String query="select * from user_register where username='"+id+"' and nominee='"+uname+"' and nominee_id='"+upass+"'";
