...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="record1.jsp">Doctor Report</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
            <center>
              <font face="Algerian" color="blue" size="6px"><center><b>DOWNLOAD PATIENT MEDICAL REPORT</b></center></font>
        ...
        <tr>
            ...
            <td align="center"><font face="Algerian" color="black" size="5px"><b>MEDICAL RECORDS</b></font></td>
...
<section class="wrapper">
           <%
             ...
             { 
                 //String uname=(String)session.getAttribute("uname");
                    ...
                    String sql = "select insurance_claim1.sno,insurance_claim1.username,insurance_claim1.policy,road_location.sno,road_location.pic,road_location.image from insurance_claim1 left join road_location on insurance_claim1.sno=road_location.sno";
     ...
     <tr> 
           ...
           <td align="center"><a href="download2?sno=<%=resultSet1.getString("sno")%>"><b>DOWNLOAD</b></a></td>
