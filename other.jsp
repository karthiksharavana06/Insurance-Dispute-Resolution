...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="other.jsp">Other</a></li> 
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <section class="wthree-row py-md-5" id="about">
        <form method="post" action="nominee_login">
            <center>
            <font face="Algerian" color="blue" size="6px"><center><b> NOMINEE LOGIN</b></center></font>
                <br> <p><font face="Algerian" color="black" size="5px"><b>USER NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp:</b></font>&nbsp;&nbsp;<input type="text" name="uid" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
            <br> <p><font face="Algerian" color="black" size="5px"><b>NOMINEE NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="username" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
             <br> <p><font face="Algerian" color="black" size="5px"><b>NOMINEE AADHAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="password" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" maxlength="12" required="" /></p>
            ...
            <div class="cpy-right">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-lg-right mt-lg-0 mt-4">
                        <p class="text-white">© 2018 Water. All rights reserved | Design by
