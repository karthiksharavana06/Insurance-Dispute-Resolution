...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="vehicle.jsp">Doctor Report</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
      ...
      %>  
      <form action="insurance_claim1" method="post" enctype="multipart/form-data"><center>
