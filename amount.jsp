...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                       ...
                       <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="amount.jsp">Approval</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
        ...
        System.out.println("select * from insurance_registra where user='"+session.getAttribute("username")+"'");
        ResultSet rs=db.Select("select * from insurance_registra where user='"+session.getAttribute("username")+"'");
        %>
        <center>
        <table border="2">
            <tr><td><font face="georgia" color="black" size="3px">Serial No</td><td><font face="georgia" color="black" size="3px">Policy Approved</td><td><font face="georgia" color="black" size="3px">User Name</td><td><font face="georgia" color="black" size="3px">Amount Approved</td><td><font face="georgia" color="black" size="3px">Contact Person</td></tr>
            
            <%
            while(rs.next())
            {
                %>
                <tr><td><font face="georgia" color="black" size="3px"><%=rs.getString("sno")%></td>
                    <td><font face="georgia" color="black" size="3px"><%=rs.getString("policy")%></td>
                    <td><font face="georgia" color="black" size="3px"><%=rs.getString("user")%></td>
                    <td><font face="georgia" color="black" size="3px"><%=rs.getString("amount")%></td>
                <td><font face="georgia" color="black" size="3px"><%=rs.getString("contact")%></td><td>
                    <%
