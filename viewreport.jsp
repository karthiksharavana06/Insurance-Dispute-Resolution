...
<body>
                ...
                <div class="nav_w3ls">
                    <nav>
                       ...
                       <ul class="menu">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="viewreport.jsp">View</a></li>
    ...
    <section class="wthree-row py-md-5" id="about">
        ...
        System.out.println("select * from view_report where p_name='"+session.getAttribute("username")+"'");
        ResultSet rs=db.Select("select * from view_report where p_name='"+session.getAttribute("username")+"'");
        %>
        <center>
        <table border="2">
            <tr><td><font face="georgia" color="blue" size="3px">Serial No</td><td><font face="georgia" color="blue" size="3px">Aadhar No</td><td><font face="georgia" color="blue" size="3px">Doctor Name</td><td><font face="georgia" color="blue" size="3px">Patient Name</td><td><font face="georgia" color="blue" size="3px">Hospital Name</td><td><font face="georgia" color="blue" size="3px">Status</td></tr>
            
            <%
            while(rs.next())
            {
                %>
                <tr><td><font face="georgia" color="blue" size="3px"><%=rs.getString("sno")%></td>
                    <td><font face="georgia" color="blue" size="3px"><%=rs.getString("hospital")%></td>
                    <td><font face="georgia" color="blue" size="3px"><%=rs.getString("reports")%></td>
                    <td><font face="georgia" color="blue" size="3px"><%=rs.getString("p_name")%></td>
                <td><font face="georgia" color="blue" size="3px"><%=rs.getString("location")%></td><td>
                    <%
