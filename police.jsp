...
<body>
    ...
    <section class="wthree-row py-md-5" id="about">
        <form method="post" action="police_login" >
            <center>
            <font face="Algerian" color="blue" size="6px"><center><b> POLICE DEPARTMENT LOGIN</b></center></font>
            <br> <p><font face="Algerian" color="black" size="5px"><b>POLICE NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font>&nbsp;&nbsp;<input type="text" name="username" style="font-weight: bold; height: 45px; width: 25%; border: 2px solid blue; font-family: Georgia; font-size: 19px; text-align: center; color:blue" required=""/></p>
           ...
           <br> <br><font face="Algerian" size="5px"><b>Are you a New User ??? Please </b><a href="police_registration.jsp"> <b>Sign Up</b> </a> <b>then...</b>
        </center>
        </form>
    </section>
