...
<body>
    ...
    <section class="wthree-row py-md-5" id="about">
        <form method="post" action="user_login">
            <center>
            <font face="Algerian" color="blue" size="6px"><center><b> NOMINEE/USER LOGIN</b></center></font>
           ...
           <br> <br><font face="Algerian" size="5px"><b>Are you a New User ??? Please </b><a href="user_registration.jsp"> <b>Sign Up</b> </a> <b>then...</b>
        </center>
        </form>
    </section>
