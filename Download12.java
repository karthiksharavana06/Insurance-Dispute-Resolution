 ...
 * @author selvarani
 */
@WebServlet(urlPatterns = {"/Download12"})
public class Download12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //    DB Db=new DB();
           ...
           ResultSet rs=db.Select("select * from road_location1 where sno='"+id+"'");
